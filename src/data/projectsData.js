export const projects = [
  ...
  {
    id: 2,
    title: "ArcGIS Experience Builder Özel Widget Mimarisi",
    description: "Hiyerarşik katman yönetimi, dinamik PDF raporlama ve TKGM koordinat entegrasyonu sağlayan özel analiz araçları ve arayüzler.",
    tech: ["React.js", "TypeScript", "Arcade Scripting"],
  ...
  },
  {
    ...
    description: "Lisans bağımlılığı olmayan açık kaynak Web-GIS portalları ve React-Leaflet / OpenLayers altyapısıyla geliştirilmiş, yüksek performanslı mekansal analiz uygulamaları.",
    tech: ["React-Leaflet", "OpenLayers", "PostGIS"],
