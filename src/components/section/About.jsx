...
export default function About() {
  return (
    <section id="about" className="py-24 px-6 max-w-[1344px] mx-auto">
      ...
      <div className="mb-14">
        <h3 className="text-3xl md:text-[32px] font-bold text-white leading-snug tracking-tight">Hakkımda</h3>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-16 items-start">
        ...
        >
          <p>
            Modern şehircilik vizyonunu ileri düzey veri otomasyonu ve web teknolojileri ile birleştiren; kurumsal CBS mimarisi ve veri mühendisliği alanlarında uzman bir <strong className="text-white font-medium">şehir plancısı ve yazılım geliştiricisiyim</strong>.
          </p>
          <p>
        ...
        >
          <div className="bg-deep border border-gunmetal p-8 rounded-[24px] relative overflow-hidden group hover:border-signal/30 transition-colors h-full flex flex-col">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <h4 className="text-xl font-bold text-white">Eğitim</h4>
            </div>
            
            <div className="mb-2 flex-1">
              <h5 className="text-lg font-bold text-white mb-2">{education[0].school}</h5>
              <p className="text-signal font-medium mb-1 text-sm">{education[0].department}</p>
              <p className="text-ash text-sm mb-4">{education[0].faculty}</p>
              ...
              <div className="flex flex-wrap items-center gap-3 mb-6">
                ...
                <a 
                  ...
                  download 
                  className="bg-signal/10 hover:bg-signal/20 border border-signal/30 text-signal hover:text-white px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2 transition-colors"
                >
